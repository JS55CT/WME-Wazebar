  ...
  function BuildSettingsInterface() {
    ...
    $section.html(
      [
        ...
        // Unread popup delay
        "<div style='display: flex; align-items: center; gap: 8px;'>",
        "<input type='number' id='WazeBarUnreadPopupDelay' min='0' style='width: 60px;' value='" +
          WazeBarSettings.UnreadPopupDelay +
          "'/>",
        ...
        "<div style='display: flex; align-items: center; gap: 8px;'>",
        "<input type='number' id='forumInterval' min='1' style='width: 60px;' value='" +
          WazeBarSettings.forumInterval +
          "'/>",
        ...
        "<a href='" +
          location.origin +
          "/forum/viewtopic.php?f=819&t=219816' target='_blank'>Forum thread</a>",
        "<div>",
    ...
    $("#btnWazebarCopySettings").click(function () {
      ...
      // Step 4: Instantiate Clipboard
      if (clipboardInstance) {
        clipboardInstance.destroy();
      }
      clipboardInstance = new Clipboard("#btnWazebarCopySettings");

      // Optional: Inform the user that settings are copied
      alert("Your settings have been copied to the clipboard.");
    });
