...
(function () {
        ...
        $section.html(
            [
                ...
                !forumPage && W.loginManager.user.rank >= 5
                    ? "<div class='checkbox-container'><input type='checkbox' id='USChampForumSetting' /><label for='USChampForumSetting'>US Champ Forum</label></div>"
                    : "",
                "<div class='checkbox-container'>",
    ...
    `;
        ...
        var statesHTML = states.map(function (state) {
