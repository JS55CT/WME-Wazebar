...
(function () {
    ...
    function BuildWazebar() {
        ...
        $Wazebar.html([
            ...
            '</div>',//End button div
            '</div></div></div>',
            // Remove the Inbox link as this is not a feacher in the new /discuss platform
        ...
        //GetPMCount(); // only used for Inbox is no longer needed with /discuss platform
        checkForums();
        StartIntervals();
        ...
        $('#WazeBarRefreshButton').click(function () {
            ...
            //window.clearInterval(inboxInterval); // only used for Inbox is no longer needed with /discuss platform
    ...
    function LoadSettingsInterface() {
        ...
        //$('#inboxInterval')[0].value = WazeBarSettings.inboxInterval;// only used for Inbox is no longer needed with /discuss platform
    ...
    */
    function checkForums() {
        ...
        if (WazeBarSettings.scriptsForum)
            checkUnreadTopics(location.origin + "/discuss/c/editors/addons-extensions-and-scripts/3984", "Scripts", "ScriptsCount"); //Scripts
        if (WazeBarSettings.USSMForum)
            checkUnreadTopics(location.origin + "/discuss/c/editors/united-states/us-state-managers/4890", "USSMForum", "USSMForumCount");
        ...
        if (WazeBarSettings.USWikiForum)
            checkUnreadTopics(location.origin + "/discuss/c/editors/united-states/us-wiki-discussion/4894", "USWikiForum", "USWikiForumCount");
    ...
    function checkUnreadTopics(path, parentID, spanID) {
        ...
        $.get(path, function (page) {
            ...
            if (count > 0) {
                ...
                pattern = /topic_unread.*\s*<dt.*>\s*<a href=".*"\s*.*<\/a>\s*<div class="list-inner.*">\s*.*\s*.*\s*.*\s*(?:.*\s*)?<a href="(.*)"\s*class="boing topictitle.*">\s*(?:<svg.*\s*<path.*\s*<\/svg>\s*)?(?!<img)(.*?)\s*<\/a>/g;
                while ((unreadItems = pattern.exec(page)) !== null) {
                    links += '<div style="position:relative;"><a href="' + location.origin + "/forum" + unreadItems[1].replace("amp;", "").substring(1) + '&view=unread#unread"' + LoadNewTab() + '>' + unreadItems[2] + '</a></div>';
                }
    ...
    function BuildRegionWikiEntries() {
        //'<div style="display:inline; padding-right:5px; margin-right:5px; border-right:thin solid grey;"><a href="hhttps://www.waze.com/wiki/USA/Great_Lakes" target="_blank">GLR Wiki</a></div>',
        var regionWikis = "";
        if (WazeBarSettings.header.region) {
            Object.keys(WazeBarSettings.header.region).forEach(function (region, index) {
    ...
    function BuildSettingsInterface() {
        ...
        $section.html([
            ...
            //'Inbox check frequency <input type="number" id="inboxInterval" min="1" style="width:50px;"> mins</br>',// only used for Inbox is no longer needed with /discuss platform
        ...
        $("#WBSettingsSave").click(function () {
            ...
            //WazeBarSettings.inboxInterval = $('#inboxInterval')[0].value;// only used for Inbox is no longer needed with /discuss platform
    ...
    function LoadStatesObj() {
        States.Alabama = { forum: "https://www.waze.com/discuss/c/editors/united-states/alabama/4839", wiki: "https://www.waze.com/wiki/USA/Southeast", abbr: "AL" };
        States.Alaska = { forum: "https://www.waze.com/discuss/c/editors/united-states/alaska/4840", wiki: "https://www.waze.com/wiki/USA/Alaska", abbr: "AK" };
        States.Arizona = { forum: "https://www.waze.com/discuss/c/editors/united-states/arizona/4841", wiki: "https://www.waze.com/wiki/USA/Arizona", abbr: "AZ" };
        States.Arkansas = { forum: "https://www.waze.com/discuss/c/editors/united-states/arkansas/4842", wiki: "https://www.waze.com/wiki/USA/Arkansas", abbr: "AR" };
        States.California = { forum: "https://www.waze.com/discuss/c/editors/united-states/california/4843", wiki: "https://www.waze.com/wiki/USA/California", abbr: "CA" };
        States.Colorado = { forum: "https://www.waze.com/discuss/c/editors/united-states/colorado/4844", wiki: "https://www.waze.com/wiki/USA/Colorado", abbr: "CO" };
        States.Connecticut = { forum: "https://www.waze.com/discuss/c/editors/united-states/connecticut/4845", wiki: "https://www.waze.com/wiki/USA/Connecticut", abbr: "CT" };
        States.Delaware = { forum: "https://www.waze.com/discuss/c/editors/united-states/delaware/4846", wiki: "https://www.waze.com/wiki/USA/Delaware", abbr: "DE" };
        States["District of Columbia"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/district-of-columbia/4847", wiki: "https://www.waze.com/wiki/USA/District_of_Columbia", abbr: "DC" };
        States.Florida = { forum: "https://www.waze.com/discuss/c/editors/united-states/florida/4848", wiki: "https://www.waze.com/wiki/USA/Southeast", abbr: "FL" };
        States.Georgia = { forum: "https://www.waze.com/discuss/c/editors/united-states/georgia/4849", wiki: "https://www.waze.com/wiki/USA/Southeast", abbr: "GA" };
        States.Hawaii = { forum: "https://www.waze.com/discuss/c/editors/united-states/hawaii/4850", wiki: "https://www.waze.com/wiki/USA/Hawaii", abbr: "HI" };
        States.Idaho = { forum: "https://www.waze.com/discuss/c/editors/united-states/idaho/4851", wiki: "https://www.waze.com/wiki/USA/Idaho", abbr: "ID" };
        States.Illinois = { forum: "https://www.waze.com/discuss/c/editors/united-states/illinois/4852", wiki: "https://www.waze.com/wiki/USA/Illinois", abbr: "IL" };
        States.Indiana = { forum: "https://www.waze.com/discuss/c/editors/united-states/indiana/4853", wiki: "https://www.waze.com/wiki/USA/Indiana", abbr: "IN" };
        States.Iowa = { forum: "https://www.waze.com/discuss/c/editors/united-states/iowa/4854", wiki: "https://www.waze.com/wiki/USA/Iowa", abbr: "IA" };
        States.Kansas = { forum: "https://www.waze.com/discuss/c/editors/united-states/kansas/4855", wiki: "https://www.waze.com/wiki/USA/Kansas", abbr: "KS" };
        States.Kentucky = { forum: "https://www.waze.com/discuss/c/editors/united-states/kentucky/4856", wiki: "https://www.waze.com/wiki/USA/Kentucky", abbr: "KY" };
        States.Louisiana = { forum: "https://www.waze.com/discuss/c/editors/united-states/louisiana/4857", wiki: "https://www.waze.com/wiki/USA/Louisiana", abbr: "LA" };
        States.Maine = { forum: "https://www.waze.com/discuss/c/editors/united-states/maine/4858", wiki: "https://www.waze.com/wiki/USA/Maine", abbr: "ME" };
        States.Maryland = { forum: "https://www.waze.com/discuss/c/editors/united-states/maryland/4859", wiki: "https://www.waze.com/wiki/USA/Maryland", abbr: "MD" };
        States.Massachusetts = { forum: "https://www.waze.com/discuss/c/editors/united-states/massachusetts/4860", wiki: "https://www.waze.com/wiki/USA/Massachusetts", abbr: "MA" };
        States.Michigan = { forum: "https://www.waze.com/discuss/c/editors/united-states/michigan/4861", wiki: "https://www.waze.com/wiki/USA/Michigan", abbr: "MI" };
        States.Minnesota = { forum: "https://www.waze.com/discuss/c/editors/united-states/minnesota/4862", wiki: "https://www.waze.com/wiki/USA/Minnesota", abbr: "MN" };
        States.Mississippi = { forum: "https://www.waze.com/discuss/c/editors/united-states/mississippi/4863", wiki: "https://www.waze.com/wiki/USA/Mississippi", abbr: "MS" };
        States.Missouri = { forum: "https://www.waze.com/discuss/c/editors/united-states/missouri/4864", wiki: "https://www.waze.com/wiki/USA/Missouri", abbr: "MO" };
        States.Montana = { forum: "https://www.waze.com/discuss/c/editors/united-states/montana/4865", wiki: "https://www.waze.com/wiki/USA/Montana", abbr: "MT" };
        States.Nebraska = { forum: "https://www.waze.com/discuss/c/editors/united-states/nebraska/4866", wiki: "https://www.waze.com/wiki/USA/Nebraska", abbr: "NE" };
        States.Nevada = { forum: "https://www.waze.com/discuss/c/editors/united-states/nevada/4867", wiki: "https://www.waze.com/wiki/USA/Nevada", abbr: "NV" };
        States["New Hampshire"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/New-Hampshire/4868", wiki: "https://www.waze.com/wiki/USA/New_Hampshire", abbr: "NH" };
        States["New Jersey"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/new-jersey/4869", wiki: "https://www.waze.com/wiki/USA/New_Jersey", abbr: "NJ" };
        States["New Mexico"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/new-mexico/4870", wiki: "https://www.waze.com/wiki/USA/New_Mexico", abbr: "NM" };
        States["New York"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/new-york/4871", wiki: "hhttps://www.waze.com/wiki/USA/New_York", abbr: "NY" };
        States["North Carolina"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/north-carolina/4872", wiki: "https://www.waze.com/wiki/USA/North_Carolina", abbr: "NC" };
        States["North Dakota"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/north-dakota/4873", wiki: "https://www.waze.com/wiki/USA/North_Dakota", abbr: "ND" };
        States.Ohio = { forum: "https://www.waze.com/discuss/c/editors/united-states/ohio/4874", wiki: "https://www.waze.com/wiki/USA/Ohio", abbr: "OH" };
        States.Oklahoma = { forum: "https://www.waze.com/discuss/c/editors/united-states/oklahoma/4875", wiki: "hhttps://www.waze.com/wiki/USA/Oklahoma", abbr: "OK" };
        States.Oregon = { forum: "https://www.waze.com/discuss/c/editors/united-states/oregon/4876", wiki: "https://www.waze.com/wiki/USA/Oregon", abbr: "OR" };
        States.Pennsylvania = { forum: "https://www.waze.com/discuss/c/editors/united-states/pennsylvania/4877", wiki: "https://www.waze.com/wiki/USA/Pennsylvania", abbr: "PA" };
        States["Rhode Island"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/rhode-island/4880", wiki: "https://www.waze.com/wiki/USA/Rhode_Island", abbr: "RI" };
        States["South Carolina"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/south-carolina/4881", wiki: "https://www.waze.com/wiki/USA/South_Carolina", abbr: "SC" };
        States["South Dakota"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/south-dakota/4882", wiki: "https://www.waze.com/wiki/USA/South_Dakota", abbr: "SD" };
        States.Tennessee = { forum: "https://www.waze.com/discuss/c/editors/united-states/tennessee/4884", wiki: "hhttps://www.waze.com/wiki/USA/Tennessee", abbr: "TN" };
        States.Texas = { forum: "https://www.waze.com/discuss/c/editors/united-states/texas/4885", wiki: "https://www.waze.com/wiki/USA/Texas", abbr: "TX" };
        States.Utah = { forum: "https://www.waze.com/discuss/c/editors/united-states/utah/4895", wiki: "https://www.waze.com/wiki/USA/Utah", abbr: "UT" };
        States.Vermont = { forum: "https://www.waze.com/discuss/c/editors/united-states/vermont/4896", wiki: "https://www.waze.com/wiki/USA/Vermont", abbr: "VT" };
        States.Virginia = { forum: "https://www.waze.com/discuss/c/editors/united-states/virginia/4897", wiki: "https://www.waze.com/wiki/USA/Virginia", abbr: "VA" };
        States.Washington = { forum: "https://www.waze.com/discuss/c/editors/united-states/washington/4898", wiki: "hhttps://www.waze.com/wiki/USA/Washington", abbr: "WA" };
        States["West Virginia"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/west-virginia/4899", wiki: "https://www.waze.com/wiki/USA/West_Virginia", abbr: "WV" };
        States.Wisconsin = { forum: "https://www.waze.com/discuss/c/editors/united-states/wisconsin/4900", wiki: "https://www.waze.com/wiki/USA/Wisconsin", abbr: "WI" };
        States.Wyoming = { forum: "https://www.waze.com/discuss/c/editors/united-states/wyoming/4901", wiki: "https://www.waze.com/wiki/USA/Wyoming", abbr: "WY" };
        States["Puerto Rico"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/puerto-rico/4879", wiki: "https://www.waze.com/wiki/USA/Puerto_Rico", abbr: "PR" };
        States["US Virgin Islands"] = { forum: "https://www.waze.com/discuss/c/editors/united-states/us-virgin-islands/4892", wiki: "https://www.waze.com/wiki/USA/Virgin_Islands", abbr: "" };
    ...
    function LoadSettingsObj() {
        ...
        var defaultSettings = {
            //inboxInterval: 5, // only used for Inbox is no longer needed with /discuss platform
            forumInterval: 2,
            scriptsForum: false,
            header: { region: {} },
            USSMForum: false,
    ...
    function SaveSettings() {
        if (localStorage) {
            ...
            */
            var localsettings = {
                //inboxInterval: WazeBarSettings.inboxInterval,// only used for Inbox is no longer needed with /discuss platform
