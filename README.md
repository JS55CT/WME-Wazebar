...
1. Once installed, open the Waze Map Editor in your browser.
2. The Wazebar will appear at the top of the editor with various links and controls.
...
Contributions are welcome! If you find any issues or have suggestions for improvements, please open an issue or create a pull request on [GitHub](https://github.com/WazeDev/Thank-The-Authors).
